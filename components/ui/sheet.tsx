...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    className={cn('fixed inset-0 z-50 bg-primary/70 backdrop-blur-sm', className)}
    {...props}
    ref={ref}
  />
));
...
>(({ className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed inset-y-0 right-0 z-50 grid w-[min(88vw,360px)] gap-4 border-l border-border bg-white p-6 shadow-lg',
        className
      )}
      {...props}
    >
